...
import schedule.sessions.LocaleFacade;
...
public class LanguageBean implements Serializable {
    ...
    private schedule.entities.Locale openScheduleLocale;
    ...
    private void initOPLocale() {
        ...
        List<schedule.entities.Locale> openScheduleLocales = ejbLocaleFacade.findAll(filter);
    ...
    public schedule.entities.Locale getOSLocale() {
