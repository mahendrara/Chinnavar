...
public abstract class Trip extends EditableEntity implements Serializable {
    ...
    @JoinTable(name = "join_trips_daytypes",
    ...
    public void cloneDataToClonedTrip(Trip newTrip) {
        ...
        newTrip.connectToCloned(this.tripType, this.trainType, this.dayTypeList);
        CopyObjects(newTrip);
    ...
    void CopyObjects(Trip newTrip) {
        ...
        newTrip.setDayTypeList(this.getDayTypeList());
    ...
    public void connectToCloned(TripType tripType, TrainType trainType, List<DayType> dayTypeList) {
